...
class MockTripHistoryProvider extends ChangeNotifier implements TripHistoryProvider {
  ...
  Future<void> fetchTripHistory() async {
    final tripHistoryData = TripHistory.fromJson(jsonDecode("{\"username\": \"dreamwarrior\", \"timestampTripHistoryMap\": {\"1748562424\": {\"distance\": \"0.6\", \"calories\": \"28.7\", \"time\": \"3.4\", \"averageAltitude\": \"0.0\", \"climb\": \"0.0\"}}}") as Map<String, dynamic>);
  ...
  SingleTripInfo? getTripByTimestamp(int timestamp) {
    // TODO: implement getTripByTimestamp
